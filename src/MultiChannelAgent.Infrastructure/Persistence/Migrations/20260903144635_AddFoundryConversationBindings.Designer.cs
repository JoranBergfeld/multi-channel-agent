...
namespace MultiChannelAgent.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903144635_AddFoundryConversationBindings")]
    partial class AddFoundryConversationBindings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MultiChannelAgent.Infrastructure.Persistence.Entities.InboxEntryEntity", b =>
                {
                    ...
                    b.HasIndex("ChannelConversationId", "Status", "ReceivedAt");
            ...
            modelBuilder.Entity("MultiChannelAgent.Infrastructure.Persistence.Entities.StockEntryEntity", b =>
                {
                    ...
                    b.Property<Guid>("LocationUniquenessKey")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InventoryId", "NormalizedName", "UnitId", "LocationUniquenessKey")
                        .IsUnique();
